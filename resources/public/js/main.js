...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t3154) {
      cljs.core.t3154 = {};
      cljs.core.t3154 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta3155 = c;
      ...
      cljs.core.t3154.cljs$lang$type = !0;
      cljs.core.t3154.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t3154")
      };
      cljs.core.t3154.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t3154")
      };
      var c = cljs.core.t3154.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t3154.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t3154.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3154.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3155
      };
      cljs.core.t3154.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t3154(this.meta, this.f, b)
      }
    }
    return new cljs.core.t3154(b, a, null)
  }(), b)
};
...
var metis = {server:{}};
metis.server.log = function() {
  var a = function(a) {
    return cljs.core.apply.call(null, console.log, cljs.core.map.call(null, cljs.core.str, a))
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
metis.server.http = require("http");
metis.server.express = require("express");
metis.server.socket_io = require("socket.io");
metis.server.page_template = function() {
  return"" + cljs.core.str('<html><head><script src="/socket.io/socket.io.js" type="text/javascript"><\/script><script src="cljs/goog/base.js" type="text/javascript"><\/script><script src="/socket.io/socket.io.js" type="text/javascript"><\/script></head><body><h1>Hello Sailor!</h1></body></html>')
};
metis.server.get_main = function(a, b) {
  return b.send(metis.server.page_template.call(null))
};
metis.server.server = function() {
  var a = metis.server.express.call(null), b = metis.server.http.createServer(a);
  metis.server.socket_io.listen(b);
  a.use(metis.server.express["static"].call(null, "static")).get("/", metis.server.get_main);
  b.listen(8080);
  return metis.server.log.call(null, "server running and listening on http://localhost:8080/")
};
metis.server._main = function() {
  var a = function() {
    var a = metis.server.express.call(null);
    metis.server.http.createServer(a);
    a.use(metis.server.express.logger()).use(metis.server.express["static"].call(null, "static")).get("/", metis.server.get_main).listen(3E3);
    return cljs.core.println.call(null, "" + cljs.core.str("Express server started on port: 3000"))
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
cljs.core._STAR_main_cli_fn_STAR_ = metis.server._main;
cljs.nodejs = {};
